...
error_file_name = strcat([res_directory f_prefix,...
     '_' str_nt int2str(NT(j)) '_' str_ne int2str(NE(j))  '_'  str_beta num2str(BETA(1))  '_.mat']);
...
title('2D asymptotic convergence, with $\delta=0.1$','interpreter','latex','FontSize',19);
