...
title('3D asymptotic convergence, with $\delta=0.0001$','interpreter','latex','FontSize',19);
...
set(gca,'XTick',[2:1:7])
axis([1 6 -16 4])
set(hFig, 'Position', [100 100 700 750])
...
output_plot_filename='~/Dropbox/Dphil/linear_poro_paper/diagrams/convergence_rescale_3d_asym'
