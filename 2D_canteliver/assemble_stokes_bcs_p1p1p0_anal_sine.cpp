        ...
        for (unsigned int ns=0; ns<side->n_nodes(); ns++)
        {
          ...
          for (unsigned int n=0; n<elem->n_nodes(); n++)
          {
            ...
            Number value_v = exact_2D_solution_v((*node), es.parameters,"null","void");
						Number value_x = fluid_fac*exact_2D_solution_x((*node), es.parameters,"null","void");
            Number value_y = fluid_fac*exact_2D_solution_y((*node), es.parameters,"null","void");
            ...
            Number value_z = fluid_fac*exact_2D_solution_z((*node), es.parameters,"null","void");
            #endif
